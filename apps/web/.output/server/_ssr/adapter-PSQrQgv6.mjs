import { o as __toESM, t as __commonJSMin } from "./chunk-C4lO9Zbh.mjs";
import { d as getEnvVar, i as BetterAuthError, l as env } from "./env-impl-vgyFsij1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/adapter-PSQrQgv6.js
...
function getOpenTelemetryAPI() {
	if (!openTelemetryAPIPromise) openTelemetryAPIPromise = import("./src-BS2nnA9H.mjs").then((n) => n.n).then((n) => /* @__PURE__ */ __toESM(n.t(), 1)).then((mod) => {
