...
//#region node_modules/.nitro/vite/services/ssr/assets/verify-2fa-B6rh7DRW.js
var import_jsx_runtime = require_jsx_runtime();
var formSchema = zod_default.object({ code: zod_default.string().length(6, "Code must be 6 digits") });
function RouteComponent() {
	...
	const form = useAppForm({
		...
		onSubmit: async ({ value }) => {
			...
			if (error) {
				toast.error(error.message || i18n._({ id: "nJ3C8v" }), { id: toastId });
				return;
			}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trans, { id: "C4pKXW" })
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-muted-foreground",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trans, { id: "H1kWmc" })
			})]
		}),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
					...
					render: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/auth/login",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(r, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trans, { id: "OvO76u" })]
					})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
			...
			render: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				to: "/auth/verify-2fa-backup",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trans, { id: "y7wH89" })
			})
		})
	] });
}
